...
public class Date implements Comparable {
  ...
  /**
   * This Date is greater than the specified Date
   * other.
   * @require    this.isComparableTo(other)
   */
  public boolean greaterThan (Comparable other) {
      assert isComparableTo(other);
      boolean greaterThan;
      Date otherDate = (Date)other;
      if (year() != otherDate.year())
        greaterThan = (year() > otherDate.year());
      else if (month() != otherDate.month())
        greaterThan = (month() > otherDate.month());
      else if (day() != otherDate.day())
        greaterThan = (day() > otherDate.day());
      else // otherDate is the same as this Date
        greaterThan = false;
      return greaterThan;
  }

  /**
   * This Date can be compared to the specified Date
   * other.
   */

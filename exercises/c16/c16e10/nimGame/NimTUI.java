...
class NimTUI {
    ...
    private void playGame (String player1Name, String player2Name,
                           int numberOfSticks, boolean newGame) {
        ...
        if (newGame) {
            ...
            player1 = game.nextPlayer();
            player2 = game.previousPlayer();
        }
    ...
    private void executeChoice (int choice) {
        ...
        if (choice == PLAY_GAME) {
            ...
            System.out.println();
            playGame(player1Name, player2Name, numberOfSticks,true);
        } else if (choice == RESTORE) {
            game = Game.restoreGame(FILE_NAME);
            playGame(null,null,0,false);
        } else if (choice == EXIT)

...
public class IntSet {
    ...
    /**
     * The set difference of this IntSet and the specified IntSet.
     */
    public IntSet difference (IntSet other) {
        IntSet large, small, difference;
        ...
        difference = new IntSet(large.maxElement());

        for (int i = 0; i <= large.maxElement(); i = i+1)
            if ((large.isIn(i) && !small.isIn(i)) ||
                (!large.isIn(i) && small.isIn(i)))
                difference.add(i);
